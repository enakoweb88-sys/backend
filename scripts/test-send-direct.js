...
async function testSendDirectToUser() {
  ...
  console.log(`2. Sending POST /employees for ${targetEmail} to production API now...`);
  ...
  console.log(`📧 Welcome email dispatched to ${targetEmail}! Check your inbox now!`);
}

testSendDirectToUser().catch(err => {
  if (err.response) {
